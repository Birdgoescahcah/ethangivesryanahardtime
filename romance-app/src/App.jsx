  ...
  const generateStory = async () => {
    ...
    const dominantDescription = answers.dominant === 'ethan' 
      ...
      : answers.emilyStrapOn === 'yes'
        ? "She has fiery red hair and a personality to match. She's bold, fierce, and knows exactly what she wants. She commands attention the moment she enters a room - confident posture, sharp wit, and a smile that promises trouble. She pins Ryan with her gaze like he's the only person who exists. She always has her strap-on ready when things heat up - and she knows exactly how to use it."
        : "She has fiery red hair and a personality to match. She's bold, fierce, and knows exactly what she wants. She commands attention the moment she enters a room - confident posture, sharp wit, and a smile that promises trouble. She pins Ryan with her gaze like he's the only person who exists.";
...
- Use first names only - do NOT give any characters last names
- For Emily: describe her presence with variety - use words like commanding, electric, magnetic, captivating, intense. Do NOT use "predatory grace" which is reserved for Ethan
