...
function App() {
  ...
  const questions = answers.dominant === 'emily' && answers.spiceLevel === '🔥'
    ? [...baseQuestions, strapOnQuestion]
    : baseQuestions;
  ...
  const generateStory = async () => {
    ...
    const dominantDescription = answers.dominant === 'ethan' 
      ...
      : answers.emilyStrapOn === 'yes'
        ? "She's bold, fierce, and knows exactly what she wants. She's the one who initiates, who pins Ryan with her gaze, who speaks with an authority that makes Ryan weak in the knees. She always has her strap-on ready when things heat up - and she knows exactly how to use it."
        : "She's bold, fierce, and knows exactly what she wants. She's the one who initiates, who pins Ryan with her gaze, who speaks with an authority that makes Ryan weak in the knees.";

    const prompt = `Write a spicy romance short story (about 1500-2000 words) about ${dominantName} and Ryan.

CHARACTER REQUIREMENTS:
- ${dominantName.toUpperCase()} is always the dominant character. ${dominantDescription}
- RYAN is the softer character based on this personality: ${answers.ryanPersonality}. He's the one who blushes, who gets flustered by ${dominantName}'s intensity, who melts under ${dominantPossessive} attention.
...
- Show the power dynamic clearly - ${dominantName} dominant, Ryan yielding
